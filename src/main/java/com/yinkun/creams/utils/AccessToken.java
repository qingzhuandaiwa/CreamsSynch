...
public class AccessToken {
	...
	public static String getToken() {
		...
		String accessToken = AccessToken.getAccessToken(PropKit.use(SynchExecutor.getFile()).get("creamsUser"),
				PropKit.use(SynchExecutor.getFile()).get("creamsPass"), PropKit.use(SynchExecutor.getFile()).get("tokenUrl"));
